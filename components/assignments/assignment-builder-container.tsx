            ...
            <SidebarInset>
                <div className="flex flex-col h-full">
                    <div className="border-b lg:h-24">
                        <h1 className="px-4 pt-6 pb-2 text-2xl font-semibold lg:px-6">Create Assignment</h1>
                        <p className="px-4 pb-4 text-sm text-muted-foreground lg:px-6">
                            Create and manage your assignment questions. Click on a question to edit it.
                        </p>
                    </div>
                    <AssignmentBuilder
                        questions={questions}
